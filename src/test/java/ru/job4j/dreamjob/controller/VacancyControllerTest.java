...
class VacancyControllerTest {
    ...
    @Test
    public void whenRequestVacancyListPageThenGetPageWithEditVacancies() {
        var vacancy1 = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
    ...
    @Test
    public void whenSomeExceptionThenGetPageWithEditVacancies() {
        when(vacancyService.findById(3)).thenReturn(Optional.empty());
    ...
    @Test
    public void whenRequestVacancyListPageThenGetPageWithUpdateVacancies() throws Exception {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var vacancyArgumentCaptor = ArgumentCaptor.forClass(Vacancy.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
    ...
    @Test
    public void whenRequestVacancyListPageThenGetPageWithDeleteVacancies() {
